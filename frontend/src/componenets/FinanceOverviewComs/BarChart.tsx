...
//   const calculateBarWidth = (totalItems: number) => {
//     const availableWidth = Dimensions.get("window").width * 0.88; 
//     const adjustedWidth = availableWidth / totalItems; // distribute the space evenly
//     return adjustedWidth * .84;
//   };

//   const barWidth = period === "Monthly" ? undefined : calculateBarWidth(data.length);
...
//             <ChartContainer>
//               {data.map((item, index) => (
//                 <BarGroup key={index} width={calculateBarWidth(data.length)}>
//                   <BarsWrapper>
