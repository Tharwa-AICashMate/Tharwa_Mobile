...
//       const response = await axios.get(`http://192.168.1.3:3000/goal/progress/${user_id}`);
...
import { useFocusEffect } from '@react-navigation/native';
import Ionicons from 'react-native-vector-icons/Ionicons';
import Toast from 'react-native-toast-message'; // <-- New Toast import
