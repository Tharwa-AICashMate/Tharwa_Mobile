...
export const getIncomeAnalyticsHandler = async (req, res) => {
    try {
...
export const getFinancialTrendsHandler = async (req, res) => {
    try {
...
export const generateFinancialReportsHandler = async (req, res) => {
    try {
