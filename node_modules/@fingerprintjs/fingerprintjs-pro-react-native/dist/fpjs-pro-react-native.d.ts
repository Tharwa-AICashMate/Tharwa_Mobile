...
declare class FingerprintJsProAgent {
    ...
    constructor({ apiKey, region, endpointUrl, fallbackEndpointUrls, extendedResponseFormat, requestOptions, }: FingerprintJsProAgentParams);
    /**
 ...
 * @group Errors
 */
declare class ClientTimeoutError extends Error {
    constructor(message: string);
}
/**
 * Other error
